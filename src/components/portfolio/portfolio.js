...
// import employee_profiles from "../../images/employee_profiles"
      ...
      portfolioArr.map(item=>{
        ...
        array.push(
            <Card
                hoverable
                style={{ width: 240 }}
                cover={<img alt={item.name} src={planitImg} />}
            >
